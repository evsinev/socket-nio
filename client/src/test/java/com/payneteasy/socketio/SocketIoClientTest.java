...
public class SocketIoClientTest {
    ...
    public void test() throws IOException, UnauthorizedException {
        ...
        client.connect(new URL("http://localhost:8080/socket.io/1/" +
                "?payber_id=1" +
                "&date=1413570429230" +
                ...
                "&v=1.2")
                , new ISocketIoListener() {

            @Override
            public void onEvent(Object aEvent, SocketIoContext aContext) {
                 LOG.debug("Event is {}", aEvent);
            }
